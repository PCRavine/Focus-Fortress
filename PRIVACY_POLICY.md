...
- **Inactive Rooms**: Room data may be automatically deleted after extended periods of inactivity
- **Account Deletion**: As we use anonymous authentication, simply uninstalling the app removes your local data. Server-side data associated with your anonymous ID will be retained according to our data retention policies.
